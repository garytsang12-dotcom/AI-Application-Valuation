...
背景（v1.15.0 脚本合并审计——框架校准「检查效验和计算脚本全局，有无合并空间」）：
...
MATRIX = {
    ...
    # 算力/Infra 段（v1.10.0 加 --tier infra，2026-09-01 框架要求——definitions.md §9 锚点入引擎）：
...
# 港股一档锚带（v1.7.12 实证校准——市值>50亿全谱系实测，增速期权在港股基本不存在）
